...
export const VEHICLES = [
  {
    ...
    speedMul: 1.3, duration: 80, color: 0x44aaff,
    ...
    statsText: ['初期速度 +30%', '走り続けると徐々に加速 → 最大 +200%(約10秒で最速)', '停止すると加速がリセットされ +30% に戻る', '低空ホバー走行 / 上下移動 不可', '持続 80秒'],
  },
  {
    id: 'veh_skyBoard',  name: 'スカイボード',  factory: veh_skyBoard,
    speedMul: 2.1, duration: 44, color: 0xff8855,
    ...
    statsText: ['移動速度 +110%', '飛行可能', '上昇 +50%', 'Shift中: 後方 暴風 & 体当たりで追い風分のダメージ', '持続 44秒'],
  },
  {
    id: 'veh_jetSkate',  name: 'ジェットスケート', factory: veh_jetSkate,
    speedMul: 2.4, duration: 42, color: 0x66ffcc,
    ...
    statsText: ['移動速度 +140%', '地表専用 超高速', '上下移動 不可', '持続 42秒'],
  },
  {
    id: 'veh_dragon',    name: '★伝説のレッドドラゴン', factory: veh_dragon,
    speedMul: 2.0, duration: 57, color: 0xff44cc,
  ...
  },
  {
    ...
    speedMul: 2.5, duration: 55, color: 0xb945ff,
